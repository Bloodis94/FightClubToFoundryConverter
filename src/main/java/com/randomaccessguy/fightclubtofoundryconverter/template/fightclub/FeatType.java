...
/**
 * <p>Java class for featType complex type</p>.
 *
...
public class FeatType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the nameOrPrerequisiteOrSpecial property.</p>
     *
     * <p>
     ...
     * </p>
     *
     * @return The value of the nameOrPrerequisiteOrSpecial property.
     */
    public List<JAXBElement<?>> getNameOrPrerequisiteOrSpecial() {
        if (nameOrPrerequisiteOrSpecial == null) {
            nameOrPrerequisiteOrSpecial = new ArrayList<>();
        }
